namespace DynamicStructure.DynamicStructure.Core.Third.Queue;
...
public class Bank
{
    ...
    public void QueueContentsCopy(Queue localQueue)
    {
        ...
        do
        {
            ...
            Console.WriteLine("Name: " + tempCustomer.name + ",  Activity: " + tempCustomer.bankingActivity +
                              ",  Account no: " + tempCustomer.accountNumber.ToString() + ", Amount $" +
